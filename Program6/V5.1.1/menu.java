  ...
  //===============================================================================
   //====================COMPONENT METHODS============
    private void launchProjectile(){
        ...
        Projectile = new Ballc(SBall, Screen, 500, 300); // Create a new Projectile object
      ...
      class Ballc extends Canvas{
        ...
        public void paint(Graphics cg) {
            ...
            if (ProjectileActive && Projectile != null) {
                g.setColor(Color.blue);
                g.fillOval(cannonCenterX, cannonCenterY, Projectile.getSizeBall(), Projectile.getSizeBall());
                g.setColor(Color.black);
                g.drawOval(cannonCenterX, cannonCenterY, Projectile.getSizeBall(), Projectile.getSizeBall());
            }
